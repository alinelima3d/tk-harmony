...
function BD_EnviarCena(){//Funcao principal
...
var cenasEp = rootRede + paths[2] + ep + "/1_Cenas";// caminho das cena do Ep na rede
...
var renderPath = "//192.168.10.101" + paths[2] + ep + "/2_Render/" + currScene;
...
var fazendinhaPath = rootRede + paths[3] + "_renderFazendinha";
var zipFazendinha = paths[8] + ep + "/1_Cenas/"+ currScene + ".zip"; //precisa um caminho diferente aqui com o servidor mapeado
